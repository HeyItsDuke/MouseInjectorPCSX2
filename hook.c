...
static FARPROC lilyfunc[21] = {NULL}; // stores lilypad's calls addresses
...
uint8_t HOOK_LoadLilyCalls(void)
{
	const char *lilyfuncnames[21] = {"PADupdate", "PS2EgetLibType", "PS2EgetLibVersion2", "PS2EgetLibName", "PADshutdown", "PADinit", "PADopen", "PADclose", "PADstartPoll", "PADpoll", "PADquery", "PADabout", "PADtest", "PADkeyEvent", "PADreadPort1", "PADreadPort2", "PADconfigure", "PADfreeze", "PADsetSlot", "PADqueryMtap", "PADsetSettingsDir"};
...
DLLEXPORT int32_t CALLBACK PADinit(uint32_t flags)
{
	return (int32_t)lilyfunc[5](flags);
}
//==========================================================================
...
{
	memready = 1;
	return (int32_t)lilyfunc[6](pDsp);
}
//==========================================================================
...
DLLEXPORT uint8_t CALLBACK PADpoll(uint8_t value)
{
	return (uint8_t)lilyfunc[9](value);
}
//==========================================================================
...
DLLEXPORT uint32_t CALLBACK PADreadPort1(void *pads)
{
	return (uint32_t)lilyfunc[14](pads);
}
//==========================================================================
...
DLLEXPORT int32_t CALLBACK PADfreeze(int32_t mode, void *data)
{
	return (int32_t)lilyfunc[17](mode, data);
}
//==========================================================================
...
DLLEXPORT int32_t CALLBACK PADsetSlot(uint8_t port, uint8_t slot)
{
	return (int32_t)lilyfunc[18](port, slot);
}
//==========================================================================
...
DLLEXPORT int32_t CALLBACK PADqueryMtap(uint8_t port)
{
	return (int32_t)lilyfunc[19](port);
}
//==========================================================================
